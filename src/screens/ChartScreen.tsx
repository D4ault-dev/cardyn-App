      ...
      <View style={{ backgroundColor: "#fff", flex: 1 }}>
          ...
          right={(
            <TouchableOpacity onPress={handleStar}>
              <AntDesign
                ...
                style={{ fontSize: RF(35), color: isFavourite ? "#F0B90B" : "black" }}
              />
            </TouchableOpacity>
          )}
        />
          ...
          {({ loading, refresh }) => (
            <ScrollView refreshControl={<RefreshControl refreshing={loading} onRefresh={refresh} />}>
              <View style={{ paddingHorizontal: 20 }}>
                <Text style={{ fontSize: RF(20), fontWeight: "500" }}>Price</Text>
        ...
        <SafeAreaView edges={["bottom"]}>
          <View style={{ paddingHorizontal: 20, flexDirection: "row", paddingVertical: 10, borderTopWidth: 1, borderTopColor: Colors.lightgray }}>
            ...
            <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
              <Button textStyle={{ fontSize: RF(13) }} onPress={handleBuyPressed} style={{ paddingHorizontal: 30 }}>BUY</Button>
            </View>
            <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
...
function Holdings(props: {
  ...
  return ctx.user
    .map((u) => (
      <View>
        <Text style={{ fontSize: RF(20), fontWeight: "500" }}>Available</Text>
        {([
...
function Price(props: {
  ...
  return (
    <Text style={{ fontSize: RF(25), color: prevPrice === price ? "gray" : prevPrice > price ? "red" : "green" }}>{price} {prevPrice > price ? "↓" : "↑"}</Text>
  )
}
