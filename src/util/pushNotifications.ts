...
//   'storeClient' = Expo Go app (NOT our app)
//   'standalone'  = standalone build (dev client or production)
//   'bare'        = bare workflow build
// appOwnership 'expo' = running inside Expo Go (legacy check)
